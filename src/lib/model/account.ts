...
import { Struct, StructData, SingleWritable, DataArr, StructDataProxy } from 'drizzle-struct/front-end';
...
export namespace Account {
	...
	export type AccountInfoData = StructData<typeof AccountInfo.data.structure>;
