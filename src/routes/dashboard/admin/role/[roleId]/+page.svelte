...
<div class="container layer-1">
    <div class="row mb-3">
        <div class="col">
            ...
            <input type="text" name="role-name" id="role-name" class="form-control h6" value={$role.name} onchange={e => {
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <input type="text" name="role-description" id="role-description" value={$role.description} class="form-control" onchange={e => {
                ...
                <div class="card layer-2 mb-3">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-middle">
                            ...
                            <button type="button" class="btn" onclick={() => role.update(d => ({
                                ...d,
                                parent: '',
                            }))}>
