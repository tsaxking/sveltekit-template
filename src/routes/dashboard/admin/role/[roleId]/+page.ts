...
export const load = (event) => {
    return {
        ...
        avaliableRulesets: Permissions.RoleRuleset.arr(event.data.availableRulesets.map(r => Permissions.RoleRuleset.Generator(r))),
        rulesets: Permissions.RoleRuleset.arr(event.data.currentRulesets.map(r => Permissions.RoleRuleset.Generator(r))),
    };
}