...
<div class="p-4 space-y-4">
  ...
  <div class="flex gap-2 items-center">
    ...
    <button class="btn" onclick={() => commandStack.undo()} disabled={!commandStack.canUndo}>Undo</button>
    <button class="btn" onclick={() => commandStack.redo()} disabled={!commandStack.canRedo}>Redo</button>
  </div>
